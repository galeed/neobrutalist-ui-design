...
import { Bell, BarChart3, CalendarDays, Home, MessageSquare, UserRound } from "lucide-react"

const items = [["#top", "Home", Home], ["#content-studio", "Create", UserRound], ["#contacts", "People", UserRound], ["#analytics", "Stats", BarChart3], ["#notifications", "Alerts", Bell]] as const
